      ...
      <div class="container">
        <div style="display:grid;grid-template-columns:2fr 1fr 1fr;gap:48px;margin-bottom:48px;">
          ...
          <div>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px;">
              ...
              <span style="font-family:var(--font-outfit);font-weight:800;font-size:16px;color:var(--color-text);">VoteSathi <span style="background:linear-gradient(135deg,#fbbf24,#f59e0b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">AI</span></span>
            </div>
            <p style="font-size:13px;color:var(--color-muted);line-height:1.75;max-width:300px;">
              An AI-powered guide to help every Indian citizen understand the election process, their rights, and how to vote confidently.
            </p>
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;">
          <p style="font-size:12px;color:var(--color-dimmed);">
            © 2025 VoteSathi AI &nbsp;·&nbsp; Not affiliated with ECI &nbsp;·&nbsp; For educational purposes only
          </p>
          <p style="font-size:12px;color:var(--color-dimmed);">
