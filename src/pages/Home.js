...
import { appendMessage, showTyping, hideTyping } from '../utils/chat-ui.js';
import { FEATURES, STEPS, PROMPT_CARDS } from '../data/homeData.js';

let chatHistory = [];

/**
 * Resets the chat history and updates the UI state.
 */
...
/**
 * Renders the home page HTML structure.
  ...
  return `
    <div id="home-wrapper" style="position:relative;">
      ...
      <div id="chat-empty-state" class="chat-empty-state" style="min-height: calc(100vh - 60px); justify-content: center; position: relative;">
        ...
        <h1 class="text-gradient-primary reveal" style="font-size: clamp(38px,6vw,56px); font-weight: 800; margin-bottom: 8px; text-align: center; letter-spacing: -1px;">Namaste, Voter</h1>
        <h2 class="reveal" style="font-size: clamp(18px, 3vw, 22px); color: var(--color-muted); margin-bottom: 40px; font-weight: 400; text-align: center; max-width: 600px; line-height: 1.5;">Your intelligent guide to the Indian Elections. Ask me anything, or explore the resources below.</h2>
        ...
        <div style="border-top:1px solid var(--color-border);padding:16px 0;flex-shrink:0;background:var(--color-bg);">
          <div class="container" style="max-width:760px;">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-top:10px;">
              <p style="font-size:11px;color:var(--color-dimmed);margin:0;">VoteSathi AI only answers Indian election questions. For official help, call <strong>1950</strong>.</p>
...
/**
 * Updates the visibility of chat states (empty vs active) based on history.
 */
...
/**
 * Sends a user message to the AI and handles the UI updates for the response.
...
/**
 * Initializes the home page, sets up event listeners, and animations.
 */
